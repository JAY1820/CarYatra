                ...
                <div className="single__comment d-flex gap-3">
                  ...
                  <div className="comment__content">
                    ...
                    <p className="section__description">
                      CarYatra is a user-friendly car rental website with advanced features,
                      including easy registration, search and filtering seamless booking,
                      and reliable customer support. Enjoy a hassle-free experience,
                      from finding the perfect car to secure transactions.
                    </p>
